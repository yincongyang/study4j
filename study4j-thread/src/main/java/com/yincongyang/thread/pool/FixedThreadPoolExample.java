package com.yincongyang.thread.pool;
...
//        final ThreadPoolExecutor threadPool = (ThreadPoolExecutor) Executors.newScheduledThreadPool(5);
        ...
        final ThreadPoolExecutor threadPool = new ThreadPoolExecutor(10,20,30l, TimeUnit.SECONDS,new ArrayBlockingQueue<Runnable>(10));
