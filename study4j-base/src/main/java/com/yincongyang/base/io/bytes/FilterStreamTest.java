 ...
 * 
 * FilterInputStream常用的子类有BufferedInputStream和DataInputStream。
 ...
 *    
 * FilterOutputStream常用的子类有BufferedOutputStream, DataOutputStream和PrintStream。
 *    (01) BufferedOutputStream的作用就是为“输出流提供缓冲功能”。
 *    (02) DataOutputStream 是用来装饰其它输出流，将DataOutputStream和DataInputStream输入流配合使用，
