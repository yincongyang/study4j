...
/**
 * ByteArrayInputStreamTest - 它包含一个内部缓冲区，该缓冲区包含从流中读取的字节； - 通俗点说，它的内部缓冲区就是一个字节数组，而ByteArrayInputStream本质就是通过字节数组来实现的。
 *
 * @author yincongyang
 */
